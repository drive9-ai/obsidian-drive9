...
const en = {
  ...
  "settings.maxFileSize.desc": "Skip files larger than this in megabytes (default: 100)",
  "settings.mobileMaxFileSize": "Mobile maximum file size",
  "settings.mobileMaxFileSize.desc": "Lower file size limit on mobile to avoid out-of-memory crashes in megabytes (default: 20)",
